...
/*$edit_data=$this->db->get_where(get_school_db().'.discount_list' , array('discount_id' => $param2,'school_id'=>$school_id))->result_array();*/
...
$edit_data_str = "select ft.* from ".get_school_db().".discount_list as ft
                          Inner join ".get_school_db().".school_discount_list as s_ft ON ft.discount_id = s_ft.discount_id
                          WHERE s_ft.school_id= $school_id AND ft.discount_id = $param2";
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <div class="form-group">
                    <label for="field-1" class="col-sm-4  control-label"><?php echo get_phrase('fee_type');?>  <span class="star">*</span>   </label>
                    <div class="col-sm-8">
  ...
  coa_list_h(0,$edit_data[0]['coa_id'],0,0,0); ?>
                ...
                <fieldset class="custom_legend">
                    ...
                    <div class="form-group">
                        <label for="field-2" class="col-sm-4  control-label"><?php echo get_phrase('Debit');?>  <span class="star">*</span>   </label>
                        <div class="col-sm-8">
                            <select name="issue_cr_coa_id" class="form-control" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>">
                                <option value=""><?php echo get_phrase('select');?></option>
                                <?php
                                coa_list_h(0,$edit_data[0]['issue_dr_coa_id'],0 , 0 , $account_type); ?>
                            </select>
...
<?php
  coa_list_h(0,$edit_data[0]['cancel_cr_coa_id'],0 , 0 , $account_type); ?>
                ...
                <!--COA while cancelling challan form End-->
					...
					*/ ?>
					<div class="form-group">
						<label for="field-2" class="col-sm-4  control-label"><?php echo get_phrase('status');?>  <span class="star">*</span>   </label>
