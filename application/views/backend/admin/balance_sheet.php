        ...
        <div class="row filterContainer" data-step="1" data-position="top" data-intro="Please select the filters and press Filter button to get specific records">
            <div class="col-md-6">
               <div class="form-group">
                  ...
                  <input id="start_date" class="form-control datepicker" autocomplete="off"  placeholder="Select Start Date" required data-format="dd/mm/yyyy" />
            ...
            <div class="col-md-6">
               <div class="form-group">
                  ...
                  <input id="end_date" class="form-control datepicker" autocomplete="off"  placeholder="Select End Date"  required data-format="dd/mm/yyyy"/>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <a id="btn_show" href="<?php echo base_url(); ?>transection_account/balance_sheet" class="modal_cancel_btn" style="display:none;padding:5px 8px !important;">
        ...
        $.ajax(
            {
                ...
                url: "<?php echo base_url();?>transection_account/get_balance_sheet",
                dataType: "html",
