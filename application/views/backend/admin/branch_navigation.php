  ...
  <header class="logo-env">
    <div class="logo text-center py-4">
      ...
      <a href="#"class="user-link"> 
        <strong style="font-size:14px;"> Welcome <?php echo $res[0]['name']; ?> </strong>
      </a>
    </div>
  </header>
  ...
  <ul class="main-menu"id="main-menu">
    ...
    <li class="<?php if($page_name=='import_list'||$page_name=='school_profiling'||$page_name=='system_settings'||$page_name=='policy_categories'||$page_name=='policies_listing'||$page_name=='event_annoucment'||$page_name=='acadmic_year_listing'||$page_name=='yearly_terms'||$page_name=='departments_listing'||$page_name=='class'||$page_name=='section_listing'||$page_name=='class_chalan'||$page_name=='student_pending'||$page_name=='policies_add_edit'||$page_name=='location'||$page_name=='subject'||$page_name=='class_routine'||$page_name=='time_table_list'||$page_name=='manage_leaves'||$page_name=='sms_setting'||$page_name=='student_evaluation'||$page_name=='manage_staff_evaluation'||$page_name=='vacation_settings'||$page_name=='add_teacher_swap'||$page_name=='manage_teacher_swap'||$page_name=='sms_templates'||$page_name=='email_templates'||$page_name=='sms_temp_listing'||$page_name=='email_temp_listing'||$page_name=='email_layout_setting' || $page_name=='preferences' || $page_name=='general_inquiry_view'||$page_name=='admission_inquiry_view'||$page_name=='landing_page')echo 'opened active has-sub'; ?>">
      ...
      <ul>
        ...
        <li class="<?php if($page_name=='event_annoucment')echo 'active'; ?>">
        ...
        <!--  </a>-->
        <!--</li>-->
        <?php }if(right_granted(array('a_preferences'))){ ?>
    ...
    <li class="<?php if( $page_name=='ledger' || $page_name=='account_transection'|| $page_name=='journal_entry'|| $page_name == 'student_fee_report_ledger' || $page_name=='trial_balance'||$page_name=='coa_list'||$page_name=='fee_types'||$page_name=='discount_list'||$page_name=='class_chalan_form'||$page_name=='chalan_settings'||$page_name=='balance_sheet'||$page_name=='depositor_listing'||$page_name=='depositor_add_edit'||$page_name=='supplier_listing'||$page_name=='supplier_add_edit'||$page_name=='deposit_listing'||$page_name=='bank_receipt_voucher_listing'||$page_name=='bank_receipt_voucher'||$page_name=='bank_receipt_voucher_edit'||$page_name=='bank_receipt_voucher_detail'||$page_name=='cash_receipt_voucher_listing'||$page_name=='cash_receipt_voucher'||$page_name=='cash_receipt_voucher_detail'||$page_name=='cash_receipt_voucher_edit'  || $page_name == 'bank_payment_voucher' || $page_name == 'bank_payment_voucher_edit' || $page_name == 'bank_payment_voucher_detail' ||$page_name=='cash_voucher_setting'||$page_name=='financial_report_settings'||$page_name=='income_statement'||$page_name=='miscellaneous_settings'||$page_name=='bank_detail_listing'||$page_name=='add_edit_bank' || $page_name == 'view_cheque_book_details'  || $page_name=='student_challan_summary'|| $page_name == 'bank_payment_voucher_listing' || $page_name == 'cash_payment_voucher' || $page_name == 'cash_payment_voucher_listing' || $page_name == 'cash_payment_voucher_edit' || $page_name=='cash_payment_voucher_detail' || $page_name=='purchase_voucher' || $page_name=='purchase_voucher_listing' || $page_name=='purchase_voucher_edit' || $page_name=='journal_voucher_listing' || $page_name=='journal_voucher_edit' || $page_name=='journal_voucher_detail' || $page_name=='journal_voucher' || $page_name=='student_ledger' || $page_name=='fee_recovery_report' || $page_name=='students_arrears'|| $page_name=='fee_concession_report' || $page_name=='breakeven_report' || $page_name=='section_wise_paid_fee' || $page_name=='class_wise_student_summary' || $page_name=='student_withdrawl_summary' || $page_name=='key_performance_indicators')echo 'opened active has-sub'; ?>">
      <a href="#">
      ...
      <ul>
        ...
        <?php //} ?>
        <li class="<?php if($page_name == 'miscellaneous_settings' ||  $page_name == 'financial_report_settings' || $page_name == 'cash_voucher_setting') echo 'opened active'; ?>">
          <a href="#">
            <i class="fas fa-cog">
            </i> 
            <span>
    ...
    <li class="<?php if($page_name=='user_type_list'||$page_name=='staff_listing'||$page_name=='staff_add_edit'||$page_name=='create_staff_card'||$page_name=='teacher'||$page_name=='user_designation'||$page_name=='manage_staff_attendance'||$page_name=='view_staff_attendance'||$page_name=='manage_leaves_staff'||$page_name=='manage_staff_eval'||$page_name=='add_staff_evaluation'||$page_name=='details_staff_evaluation'||$page_name=='view_staff_attendance')echo 'opened active has-sub'; ?>">
      <a href="#">
        <i class="fas fa-users-cog">
        </i> 
        <span>
      ...
      <ul>
        ...
        <li class="<?php if($page_name=='manage_attendance'||$page_name=='view_student_attendance'||$page_name=='view_staff_attendance'||$page_name=='manage_staff_attendance')echo 'opened active'; ?>">
          <a href="#">
    ...
    <li class="<?php if($page_name=='bulk_class_leave'||$page_name=='student_add'||$page_name=='student_information'||$page_name=='student_m_discount'||$page_name=='student_m_installment'||$page_name=='payment_listing'||$page_name=='view_print_chalan'||$page_name=='student_chalan_edit'||$page_name=='student_information_pending'||$page_name=='update_parent'||$page_name=='student_detail'||$page_name=='student_marksheet'||$page_name=='assessment/view_assessment'||$page_name=='assessment/view_assessment_audience'||$page_name=='promotion_request'||$page_name=='bulk_chalan_listing'||$page_name=='chalan_detail_listing'||$page_name=='promotion_listing'||$page_name=='promotion_chalan_listing'||$page_name=='transfer_information'||$page_name=='withdraw_listing'||$page_name=='manage_attendance'||$page_name=='view_student_attendance'||$page_name=='exam_routine'||$page_name=='Transfer_listing_req'||$page_name=='exam'||$page_name=='grade'||$page_name=='exam_weightage' || $page_name=='open_student_marksheet' ||$page_name=='marks'||$page_name=='diary'||$page_name=='manage_leaves_student'||$page_name=='view_student_attendance'||$page_name=='create_card'||$page_name=='stud_evaluation'||$page_name=='modal_view_stud_evaluation'||$page_name=='stud_evaluation_form'||$page_name=='receiving_transfer_list'||$page_name=='student_attendance_summary'||$page_name=='student_admission_status_report' || $page_name=='date_wise_attendance_summary' ||$page_name=='subjectwise_attendance' || $page_name=='student_credential_view' || $page_name=='student_credential_list')echo 'opened active has-sub'; ?>">
      <a href="#">
        <i class="fas fa-user-cog">
        </i> 
        <span>
      ...
      <ul>
        ...
        <li class="<?php if($page_name=='student_information'||$page_name=='create_card'||$page_name=='payment_listing'||$page_name=='student_chalan_edit'||$page_name=='view_print_chalan'||$page_name=='student_m_discount'||$page_name=='student_m_installment')echo 'active'; ?>">
        ...
        <li class="<?php if($page_name=='bulk_chalan_listing'||$page_name=='chalan_detail_listing')echo 'active'; ?>">
        ...
        <?php }if(right_granted(array('students_promote'))){ ?>
        ...
        <li class="<?php if($page_name=='subjectwise_attendance'||$page_name=='manage_attendance'||$page_name=='view_student_attendance'||$page_name=='student_attendance_summary')echo 'opened active'; ?>">
          <a href="#">
            <i class="fas fa-user-check">
            </i> 
            <span>
          ...
          <ul>
            ...
            <li class="<?php if($page_name=='manage_attendance')echo 'active'; ?>">
              <a href="<?php echo base_url(); ?>attendance/manage_attendance/<?php echo date('d/m/Y'); ?>">
                <i class="fas fa-file-signature">
                </i> 
                <span>
                  <?php echo get_phrase('manage attendance'); ?>
                </span>
              </a>
            </li>
            ...
            <li class="<?php if($page_name=='view_student_attendance')echo 'active'; ?>">
              <a href="<?php echo base_url(); ?>attendance/view_stud_attendance">
                ...
                <span>
                  <?php echo get_phrase('view_attendance'); ?>
                </span>
              </a>
            </li>
            <?php }{ ?>
        ...
        <li class="<?php if($page_name=='exam'||$page_name=='grade'||$page_name=='exam_weightage'||$page_name=='marks'||$page_name=='student_marksheet'||$page_name=='exam_routine' || $page_name=='open_student_marksheet')echo 'opened active'; ?>">
          ...
          <ul>
            ...
            <li class="<?php if($page_name=='open_student_marksheet')echo 'opened active'; ?>">
              <a href="<?php echo base_url(); ?>exams/student_marksheet/<?php echo $row['class_id']; ?>">
        ...
        <li class="<?php if($page_name=='admission_status_report')echo 'active'; ?>">
          <a href="<?php echo base_url(); ?>c_student/student_admission_status_report">
            <span>
              <i class="fas fa-user-circle">
              </i>
              <?php echo get_phrase('admission_status_report'); ?>
            </span>
          </a>
        </li>
        
        <li class="<?php if($page_name=='bulk_class_leave')echo 'active'; ?>">
            <a href="<?php echo base_url(); ?>c_student/student_listing">
                <span>
                  <i class="fas fa-forward">
                  </i>
                  <?php echo get_phrase('class_leave'); ?>
                </span>
            </a>
        </li>
    ...
    <!-- <li class="<?php if($page_name=='user_group_list'||$page_name=='action'||$page_name=='assign_rights'||$page_name=='admin_staff_listing')echo 'opened active'; ?>">
      <a href="#">
        <i class="fas fa-user-shield">
        </i> 
        <span>
          <?php echo get_phrase('system_admin'); ?>
        </span>
      </a>
      <ul>
