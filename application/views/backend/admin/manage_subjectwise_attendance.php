...
<script>
    $(window).on("load",function() {
        ...
        <form id="student_attendance" method="post" action="<?php echo base_url();?>attendance/manage_subjectwise_attendance" class="form validate">
            <div class="">
		...
		<script>
         ...
         <form method="post" id="attendance_form" action="<?php echo base_url();?>attendance/apply_subjectwise_attendence/<?php echo $date.'/'.$month.'/'.$year;?>">
            <div class="row">
