<?php 
    $edit_data = $this->db->get_where(get_school_db().'.staff_evaluation_questions' , array(
    	'staff_eval_form_id' => $param2,
...
<div class="panel panel-primary" data-collapsed="0">
    <div class="panel-heading">
		<div class="panel-title black2">
            ...
            <?php echo get_phrase('edit_staff_evaluation_questions');?>
		</div>
	</div>
    
    <div class="panel-body">
        <?php foreach($edit_data as $row):?>
        <?php echo form_open(base_url().'staff_evaluation/staff_eval/do_update/'.$row['staff_eval_form_id'] , array('id'=>'disable_submit_btn','class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
