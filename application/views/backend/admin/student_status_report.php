...
<?php
    ...
    <div data-step="1" data-position='top' data-intro="Please select filters and press filter button to get specific records">
    <form action="<?php echo base_url(); ?>c_student/get_student_admission_status_report" method="post" name="student_form">
        <div class="row filterContainer">    
            ...
            <div class="col-md-4 col-lg-4 col-sm-6">
                <label for="status_id_filter_selection">Select Admission Status</label>
                <select id="status_id" class="selectpicker form-control" name="status_id" required>
                    <option value="">Select Status</option>
                        <?php echo admission_status();?>
                </select> 
            </div>   
            <div class="col-md-6 col-lg-6 col-sm-6 mt-3">
                ...
                <?php if ($apply_filter == 1) { ?>
                    <a id="btn_show" href="<?php echo base_url(); ?>c_student/student_status_report" class="modal_cancel_btn" style="padding:5px 8px !important;"> <i class="fa fa-remove"></i><?php echo get_phrase('remove_filters');?></a>
                <?php } ?>
            </div>
        </div>
    </form>
 ...
 ?>" class="img-circle" width="30" />
     ...
     <?php
                            ...
                            if($controller=='s')
                            {
                            	...
                            	$c_update="admin/update_parent/".$controller."/".$row['student_id']."/".$row['section_id'];
                          }
                            ?>          <a href="<?php echo base_url(); ?><?php echo $c_update;?>">
                                            <i class="fas fa-user-friends"></i>
                                            <?php echo get_phrase('update_parent'); ?>
                                            /
                                            <?php echo get_phrase('guardian');?>
                                ...
                                ?>
                                    ...
                                    <li>
                                        <a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/admission_status_change/<?php echo $row['student_id'];?>');">
                                            ...
                                            <?php echo get_phrase('admission_status');?>
                                        </a>
                                    </li>
                                    <?php
