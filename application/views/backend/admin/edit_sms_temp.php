    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-xs-6 myt topbar">
            <h3 class="system_name">
                ...
                <?php echo get_phrase('Edit_SMS_templates');?>
    ...
    <?php echo form_open(base_url()."templates/update_sms_temp"); ?>
    <input  type="hidden" class="form-control" name="sms_temp_id" value="<?php echo $sms_edit_arr[0]['sms_temp_id'];?>">
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="">
                            <input maxlength="100" type="text" class="form-control" name="sms_title" value="<?php echo $sms_edit_arr[0]['sms_title'];?>" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label">
                        ...
                        <div class="">
                            <textarea maxlength="160" id="sms_content" oninput="count_value('sms_content','sms_count','160')" class="form-control" name="sms_content" rows="5"><?php echo $sms_edit_arr[0]['sms_content'];?></textarea>
                    ...
                    <div class="form-group">
    					...
    					<div class="">
    						<select name="sms_template_status" id="sms_template_status" class="form-control" required >
    						    <option value="1" <?php if($sms_edit_arr[0]['sms_template_status']==1) echo 'selected';?> ><?php echo get_phrase('active');?></option>
							    <option value="0" <?php if($sms_edit_arr[0]['sms_template_status']==0) echo 'selected';?> ><?php echo get_phrase('inactive');?></option>
    						</select>
    					</div>
    				</div>
                    <div class="form-group">
