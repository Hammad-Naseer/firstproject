...
<?php
    ...
    if($section_id==0){
    	...
    	$section_id_count.="  and s.section_id=$section_id ";
    }
    
    if($chalan_type==0){
    	$section_id_count.="";
    }else{
    	$section_id_count.=" and scf.form_type=$chalan_type ";
    }
    ...
    and scf.s_c_f_month in ($month_str) and scf.s_c_f_year in ($year_str)
    and scf.status=5  $section_id_count
