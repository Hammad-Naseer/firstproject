	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url().'admin/accountant/create/' , array('id'=>'disable_submit_btn','class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
...
function get_cnic(){
	...
	var cnic=$('#cnic').val();
      ...
      type: 'POST',
       data: {cnic:cnic},
      url: "<?php echo base_url();?>admin/get_cnic_account",
      dataType: "html",
      success: function(response) { 
if($.trim(response)=='yes'){
