...
<div>
    <form action="<?php echo base_url().'attendance/view_subjectwise_attendance'?>" method="post" >    
        <div class="row filterContainer">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6" data-step="2" data-position="top" data-intro="press this button to view student attendance record">
                ...
                <?php if($apply_filter){?>
                <a href="<?php echo base_url().'attendance/view_subjectwise_attendance'?>"  class="modal_cancel_btn">Remove Filter</a>
                <?php }?>
...
<div class="col-lg-12 col-md-12 col-sm-12">
    ...
    ?>
        <tr>
            ...
            <a href="<?php echo base_url()."attendance/student_subjectwise_attendance/".str_encode($row['student_id'])?>"  class="btn btn-primary"><?php echo get_phrase('view_subject_wise_attendance');?></a>
            <?php }?>
            </td>
        </tr>
    <?php
