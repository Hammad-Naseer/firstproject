		...
		<div class="tab-content">
			...
			<div class="tab-pane active" id="edit" style="padding: 5px">
                <div class="">
						...
						$count = 0;
						$language_phrases	=	$this->db->query("SELECT `phrase_id` , `phrase` , `$current_editing_language` FROM ".get_school_db().".language")->result_array();
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open(base_url().'admin/manage_language/add_phrase/' , array('id'=>'add_phrase_form','class' => 'form-horizontal form-groups-bordered validate'));?>
                        <div class="padded">
			...
			<div class="tab-pane box" id="add_lang" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open(base_url().'admin/manage_language/add_language/' , array('id'=>'disable_submit_btn','class' => 'form-horizontal form-groups-bordered validate'));?>
                        <div class="padded">
                            <div class="form-group">
