...
if($this->session->flashdata('club_updated')){
  ...
  ?>
    ...
    <div>
        <form id="filter" name="filter" method="post" action="<?php echo base_url();?>leaving_certificate_student/view_leaving_certificate_student" class="form-horizontal form-groups-bordered validate " style="background-color:rgba(0, 0, 0, 0) !important;     margin-top: -14px;">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 mgt10" data-step="2" data-position="top" data-intro="Step 2: select student">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 mt-3" data-step="3" data-position="top" data-intro="Press this button to get student attendance summary report">
                    ...
                    <a href="<?php echo base_url(); ?>leaving_certificate_student/view_leaving_certificate_student" style="display: none;" class="btn btn-danger" id="btn_remove">
...
<thead>
            <td><?php echo get_phrase('month_-_year');?></td>
