<div class="panel panel-primary" data-collapsed="0">
    <div class="panel-heading">
    	<div class="panel-title black2">
            ...
            <?php echo get_phrase('add_student_evaluation_questions');?>
        </div>
    </div>
    <div class="panel-body">
    	<?php echo form_open(base_url().'evaluation/stud_evaluation/create' , array('id'=>'disable_submit_btn','class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="eval_type" id="eval_type">
                        <option value="1"><?php echo get_phrase('exam');?></option>
                        <option value="2"><?php echo get_phrase('general');?></option>
                    </select>
                </div>
                <div class="form-group">
