...
<script>
    ...
    <form action="<?php echo base_url();?>transection_account/ledger" name="add" id="search_ledger" method="POST">
        <div>
            <div class="row filterContainer" data-step="1" data-position="top" data-intro="Please select the filters and press Filter button to get specific records">
                ...
                <div class="col-md-4">
                   <div class="form-group">
                        ...
                        <input id="start_date" name="start_date" autocomplete="off"  class="form-control datepicker" value="<?php echo date_dash($start_date);?>" placeholder="Select Start Date" required data-format="dd/mm/yyyy" style="height: 44px;"/>
                ...
                <div class="col-md-4">
                   <div class="form-group">
                        ...
                        <input id="end_date" name="end_date" autocomplete="off"  class="form-control datepicker"  value="<?php echo date_dash($end_date);?>" placeholder="Select End Date" required data-format="dd/mm/yyyy" style="height: 44px;" />
    ...
    <div class="row">
        <?php if (!empty($journal_result)){ ?>
            ...
            <form action="<?php echo base_url();?>transection_account/ledger_pdf" method="post">
            ...
            <form action="<?php echo base_url();?>transection_account/ledger_excel" method="post">
                <input type="hidden" name="coa_id" value="<?= $coa_id ?>">
                <input type="hidden" name="start_date" value="<?= $start_date ?>">
                <input type="hidden" name="end_date" value="<?= $end_date ?>">
        ...
        <?php //if (!empty($journal_result)){ ?>
            <!--<div class="center">-->
            <!--    <h1><b>Ledger Report</b></h1>-->
            <!--    <h4><b>Account Title : </b> <?= get_coa_name($coa_id) ?></h4>-->
            <!--    <p><b>FROM : </b> <?= date_dash($start_date); ?> - <b>To : </b> <?= date_dash($end_date); ?></p>-->
            <!--</div>-->
        <?php //} ?>
        <table class="table table-bordered" ata-step="6" data-position='top' id="table_export_exp" data-intro="all ledger records">
            <thead>
                <?php if (!empty($journal_result)){ ?>
                    <tr>
                        <td colspan="6" align="center" style="background-color:white !important;">
                            <h1><b>Ledger Report</b></h1>
                            <h4><b>Account Title : </b> <?= get_coa_name($coa_id) ?></h4>
                            <p><b>FROM : </b> <?= date_dash($start_date); ?> - <b>To : </b> <?= date_dash($end_date); ?></p>
                        </td>
