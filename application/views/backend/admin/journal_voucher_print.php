		...
		<table>
			<tr>
				<td>
	            	...
	            	<?php echo $journal_voucher_detail_arr[0]['voucher_number'];?>
            	</td>
				<td>
					<strong>
	            	...
	            	<?php 
	            		echo date_view($journal_voucher_detail_arr[0]['voucher_date']);
	            	?>
				</td>
			</tr>
			<tr>
				<td>
	            	...
	            	<?php echo date_view($journal_voucher_detail_arr[0]['date_posted']);?>
				</td>
			</tr>
		</table>
</div>
...
<div id="table_data" style="margin-top: 20px;">
    ...
    <th><?php echo get_phrase('credit_coa');?></th>
    ...
    <?php
        $total = 0;
        foreach ($journal_voucher_detail_arr as $key => $value) {
    ?>
    <tr>
        <td>
        <?php echo get_coa_name($value['debit_coa_id']);?>
        </td>
        <td>
        <?php echo get_coa_name($value['credit_coa_id']);?>
        </td>
        <td>
	        <?php
	        	$total += $value['amount'];
    ...
    <?php if (empty($journal_voucher_detail_arr)) { ?>
	...
	<table>
		...
		<tr>
			...
			<?php 
				...
				<?php
				$user_detail = get_user_login_detail($journal_voucher_detail_arr[0]['submitted_by']);
			...
			<?php
				...
				<?php
				$user_detail = get_user_login_detail($journal_voucher_detail_arr[0]['posted_by']);
				echo $user_detail['name'];
				?>
			</td>
		</tr>
