    ...
    <div class="row">
        <div class="col-lg-6 col-md-12 col-xs-6 myt topbar">
            <h3 class="system_name">
                ...
                <?php echo get_phrase('email_templates');?>
                 
            </h3>
        </div>
        <div class="col-lg-6 col-md-6 col-xs-6 myt topbar">
            <a href="<?php echo base_url(); ?>templates/email_temp_listing" target="_blank" class="btn btn-primary" style="float:right;"><?php echo get_phrase('View_Email_Template');?></a>
        </div>
    </div>
    <?php echo form_open(base_url()."templates/save_email_template"); ?>
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="">
                            <input maxlength="100" type="text" class="form-control" name="email_title" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label">
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            <textarea maxlength="300" id="email_content" oninput="count_value('email_content','email_count','300')" class="form-control" name="email_content" rows="5"></textarea>
                            <div id="email_count" class=""></div>
                        </div>
                    </div>
                    <div class="form-group">
    					<label class="control-label">
    					...
    					<div class="">
    						<select name="email_template_status" id="email_template_status" class="form-control" required >
