...
<div class="row">
    ...
    <div class="col-lg-4 col-md-4 col-sm-4">
        <h3 class="system_name inline"><?php echo get_phrase('paid_students');?>
        </h3>
    </div>
...
<form action="<?php echo base_url().'reports/paid_students/'.$d_school_id?>" method="post" name="paid_student_form" id="paid_student_form">
    <div class="row filterContainer"> 
        ...
        <div class="col-md-6 col-lg-6 col-sm-6 pt-3"> 
            ...
            <a id="btn_show" href="<?php echo base_url().'reports/paid_students/'.$d_school_id?>" class="btn btn-danger" style="padding:5px 8px !important;"> <i class="fa fa-remove"></i><?php echo get_phrase('remove_filters');?></a>
            </div>
            <?php
            }
            ?> 
            <input class="btn btn-primary" type="submit" id="paid_students_pdf" value="<?php echo get_phrase('get_pdf');?>">
        <!-- </div>
        <div class="col-md-6 col-lg-6 col-sm-6"> -->
            <input class="btn btn-primary" type="submit" id="paid_students_excel" value="<?php echo get_phrase('get_excel');?>">
        </div> 
