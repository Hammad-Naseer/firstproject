    ...
    <div id="header" style="height: 100px; width: 100%;">
        ...
        <div style="float: left; margin-top: -25px; margin-left: 150px;"> 
            ...
            <h4 style="margin-top: -15px;">
                <?php echo get_phrase('date_wise_attendance_summary_print');?>
            </h4>
        </div>
    </div>
        <?php
        ...
        <div id="table_data" style="margin-top: 20px;">
            ...
            <th style="width: 55px;"><?php echo get_phrase('present_days');?> #</th>
            <th style="width: 65px;"><?php echo get_phrase('absent_days');?></th>
            <th style="width: 65px;"><?php echo get_phrase('leaves_days');?></th>
            </tr>
            </thead>
            <tbody>
            <?php
            ...
            <tr>
                ...
                <td><?php echo $value['total_leaves'];?></td>
            </tr>
            <?php
            }
            ?>
