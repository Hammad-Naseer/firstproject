        ...
        <div id="table_data" style="margin-top: 20px;">
            ...
            <tr>
                ...
                <?php
                    ...
                    {
                        $payment_date = date_view($value['payment_date']);
                        echo $payment_date;
                    }
                ?>
                </td>
                <td>
                    <b>Total Amount : </b>
                    <?php echo $value['actual_amount'];?>
                    <br>
                    <b>Received Amount : </b>
                    <?php echo $value['received_amount'];?>
                    <br>
                    <b>Arrears : </b>
                    <?php echo $value['arrears'];?>
                </td>
            </tr>

            <?php
            }
            if ($total_amount>0 || $total_received>0 || $total_arrears>0)
            {
            ?>
            <tr>
