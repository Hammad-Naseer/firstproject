<div class="panel panel-primary" data-collapsed="0">
    <div class="panel-heading">
    	<div class="panel-title black2">
            ...
            <?php echo get_phrase('add_student_evaluation_rating');?>
        </div>
    </div>
    <div class="panel-body">
    	<?php echo form_open(base_url().'evaluation/evaluation_rating/create' , array('id'=>'disable_submit_btn','class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
