...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 myt topbar">
        ...
        <h3 class="system_name inline">
             <?php echo get_phrase('virtual_classes_complete');?>
        </h3>
    </div>
</div>
    <div>
    <form action="<?php echo base_url(); ?>virtualclass/vc_complete_list" method="post" name="student_form" data-step="1" data-position="top" data-intro="Please select the filters and press Filter button to get specific records">
        <div class="row filterContainer">
			...
			?>
             <div class="col-md-6 col-lg-6 col-sm-6">
                <a id="btn_show" href="<?php echo base_url(); ?>virtualclass/vc_complete_list" class="btn btn-danger" style="padding:5px 8px !important;"> <i class="fa fa-remove"></i><?php echo get_phrase('remove_filters');?></a>
            </div>
            <?php
			}
			?>
...
<div class="col-lg-12 col-sm-12">
    <table class="table table-bordered table_export" data-step="2" data-position="top" data-intro="complete virtual class record">
    <thead>
        <tr>
        ...
        <tr>
            ...
            <td>
                <?php 
                    ...
                    $getUrl = WEBRTC_LINK."api/isMeetingRunning?";
            		$params = '&meetingID='.urlencode($meetingId).
            		'&password='.urlencode('mp');
                    $url_get = $getUrl.$params.'&checksum='.sha1("isMeetingRunning".$params.WEBRTC_SECRET);
                    $xmldata = simplexml_load_file($url_get) or die("Failed to load");
                    //print_r($xmldata);
                    if($xmldata->running == 'true')
                        echo "<strong><span style='color:red'>Class Active</span></strong>";
                    else
                        echo "<strong><span style='color:green'>Class Completed</span></strong>";
                ?>
            </td>
            <td class="td_middle">
                <div>
                    <div class="btn-group" data-step="3" data-position="left" data-intro="current virtual class options: view details">
