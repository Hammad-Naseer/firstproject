		...
		<div class="tab-content">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered datatable" id="table_export">
                	<thead>
                		<tr>
                            ...
                            <th><div><?php echo get_phrase('number_of_books');?></div></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $this->crud_model->get_type_name_by_id('book_category',$row['book_category_id']);?></td>
                            <td><?php echo $row['number_books'];?></td>
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open(base_url().'admin/book/create' , array('class' => 'form-horizontal form-groups-bordered validate',
