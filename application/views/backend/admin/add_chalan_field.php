	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url().'fee_types/fee_types_c/add_edit/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data','id'=>'disable_submit_btn'));?>
					...
					<div class="form-group">
                        ...
                        echo fee_type_option_list_new($fee_type_id1,$query_edit[0]['type_id'],$param3 , $s_c_f_id , $s_c_d_id , $form_status);
                         ?>
						</select>
                ...
                <?php if($param3 == 1) { ?>
					<div class="form-group">
                      ...
                      <div class="col-sm-8">
							<input id="amount" type="text" class="form-control" name="amount" value="<?php echo $query_edit[0]['amount']; ?>" >
                ...
                <?php  if($param3 == 2) {
                   ...
                   if(!empty($query_edit[0]['fee_type_id']))
                   {
                    ...
                    $amount_str = "SELECT DISTINCT s.amount as am , s.s_c_d_id as related_id FROM ".get_school_db().".discount_list as d
                        ...
                        INNER JOIN ".get_school_db().".student_chalan_detail as s on s.fee_type_id = f.fee_type_id
                ...
                <div class="form-group">
                    <label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('amount');?></label>
                    <div class="col-sm-8">
                     <input id="actual_amount" type="text" class="form-control" name="actual_amount" value="<?php echo round($amount_current); ?>">
...
<script>
	...
	$.ajax({
			type: 'POST',
			data: {fee_type_id:fee_type_id,title:title,s_c_f_id:s_c_f_id,type:type,amount:amount,s_c_d_id:s_c_d_id},
			url: "<?php echo base_url();?>class_chalan_form/save_chalan_field",
			dataType: "html",
