		...
		<table>
			<tr>
				<td>
	            	...
	            	<?php echo $cash_payment_detail_arr[0]['voucher_number'];?>
            	</td>
				<td>
					<strong>
	            	...
	            	<?php 
	            		echo date_view($cash_payment_detail_arr[0]['voucher_date']);
	            	?>
				</td>
			</tr>
			<tr>
				<td>
	            	...
	            	<?php
	            	if($cash_payment_detail_arr[0]['supplier_id']){
    	            	$supplier_detail = get_depositor_details($cash_payment_detail_arr[0]['supplier_id']);
				...
				<td>
	            	...
	            	<?php echo date_view($cash_payment_detail_arr[0]['date_posted']);?>
				</td>
			</tr>
		</table>
</div>
...
<div id="table_data" style="margin-top: 20px;">
    ...
    <?php
    $total = 0;
    foreach ($cash_payment_detail_arr as $key => $value)
    {
    ?>
    <tr>
    ...
    <?php
        if (empty($cash_payment_detail_arr)) {
        ?>
	...
	<table>
		...
		<tr>
			...
			<?php 
				...
				<?php
				$user_detail = get_user_login_detail($cash_payment_detail_arr[0]['submitted_by']);
			...
			<?php
				...
				<?php
				$user_detail = get_user_login_detail($cash_payment_detail_arr[0]['posted_by']);
				echo $user_detail['name'];
				?>
			</td>
		</tr>
