       ...
       <div class="col-lg-12 col-md-12 col-sm-12 myt topbar">
           <a style="float:right;color:blue;font-size: 15px;" href="javascript:void(0);" id="chalan_tour" onclick="javascript:introJs().start();">
            ...
            <h3 class="system_name inline capitalize"> 
                <?php echo get_phrase('student_leaving_certificate'); ?>
            </h3>
        </div>
    </div>
    
    <div>
        <form id="leaving_certificate_student_form" name="filter" method="post" action="<?php echo base_url();?>certificate/leaving_certificate" class="form-horizontal form-groups-bordered validate " style="background-color:rgba(0, 0, 0, 0) !important;     margin-top: -14px;">
            <div class="row filterContainer">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 mt-3" data-step="3" data-position="top" data-intro="Press this button to get student leaving certificate">
                    
                    <input type="hidden" name="apply_filter" value="1">
                    <input type="submit" id="btn_submit" value="<?php echo get_phrase('filter');?>" class="modal_save_btn"> 
                    <?php if ($apply_filter == 1) { ?>
                        <a id="btn_show" href="<?php echo base_url().'certificate/leaving_certificate'?>" class="modal_cancel_btn" style="padding:5px 8px !important;"> <i class="fa fa-remove"></i><?php echo get_phrase('remove_filters');?></a>
                ...
                <div class="leaving-certificate Container py-5">
                    <div class="row  d-flex align-items-center justify-content-between">
                        ...
                        <div class="col-sm-12 col-md-9 d-flex justify-content-center">
                           <img src="<?php echo base_url(); ?>assets/certificate_ribbons/Leaving-Certificate.png" class="img-fluid w-75">
                        </div>
                        
                        <div class="col-sm-12 col-md-12 d-flex justify-content-center py-5">
                           <p style="text-align: justify;">
                               It is certified that <span><?php echo $student_data->name; ?></span> s/o <span><?php echo $student_data->father_name; ?></span>
                               is a bonafide student of this School and bear a good moral character. <span><?php echo $student_data->name; ?></span> behaviour was good with teachers and students. We wish <span><?php echo $student_data->name; ?></span>  a very bright future. 
                               
                               This certificate is being issued upon the request of the above-named student for___
                           </p>
                        </div>
...
<script>
    ...
    $('#print_pdf').click(function(){
        ...
        $('#leaving_certificate_student_form').attr('action', '<?php echo base_url(); ?>certificate/leaving_certificate_pdf');
        $('#leaving_certificate_student_form').submit();
    });
