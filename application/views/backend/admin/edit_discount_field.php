...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
          ...
          <?php echo form_open(base_url().'fee_types/fee_types_c/add_edit/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data','id'=>'edit_discount_form_id'));?>
					...
					<div class="form-group">
                        ...
                        echo edit_discount_chalan_form($query_edit[0]['type_id'], $s_c_f_id , $s_c_d_id);
                         ?>
						</select>
               ...
               <?php if($param3 == 2)
                ...
                <?php  if($param3 == 2) {
                    $discount = 0;
                   if(!empty($query_edit[0]['type_id']))
                   {
                       $discount = $query_edit[0]['type_id'];
                   }
...
<script>
	...
	$("#amount_validation").show();
        ...
        if ($("#edit_discount_form_id").valid()) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url();?>class_chalan_form/edit_discount_chalan_form",
                dataType: "html",
