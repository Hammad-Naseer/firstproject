		...
		<table>
			<tr>
				<td>
	            	...
	            	<?php echo $bank_payment_detail_arr[0]['voucher_number'];?>
            	</td>
				<td>
					<strong>
	            	...
	            	<?php 
	            		echo date_view($bank_payment_detail_arr[0]['voucher_date']);
	            	?>
				</td>
			</tr>
			<tr>
				<td>
	            	...
	            	<?php
	            	if($bank_payment_detail_arr[0]['supplier_id'] != ""){
    	            	$supplier_detail = get_supplier_details($bank_payment_detail_arr[0]['supplier_id']);
    	            	echo $supplier_detail[0]['name'];
	            	}else{
	            	    echo "Other Payment";
	            	}
	            	?>
				...
				<td>
	            	...
	            	<?php echo date_view($bank_payment_detail_arr[0]['date_posted']);?>
				</td>
			</tr>
		</table>
</div>
...
<div id="table_data" style="margin-top: 20px;">
    ...
    <th style="width: 65px;"><?php echo get_phrase('bank');?></th>
    ...
    <?php
    $total = 0;
    foreach ($bank_payment_detail_arr as $key => $value)
    {
    ?>
    <tr>
        ...
        <td>
        <?php 
        	$bank_detail = get_bank_details($value['bank_from_id']);
    ...
    <?php
        if (empty($bank_payment_detail_arr)) {
        ?>
	...
	<table>
		...
		<tr>
			...
			<?php 
				...
				<?php
				$user_detail = get_user_login_detail($bank_payment_detail_arr[0]['submitted_by']);
			...
			<?php
				...
				<?php
				$user_detail = get_user_login_detail($bank_payment_detail_arr[0]['posted_by']);
				echo $user_detail['name'];
				?>
			</td>
		</tr>
