...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 myt topbar">
        <h3 class="system_name inline">
            <?php echo get_phrase('edit_journal_voucher');?>
        </h3>
    </div>
</div>

<div class="col-lg-12 col-md-12 col-sm-12">
<?php echo form_open(base_url().'vouchers/journal_voucher_update' , array('id'=>'journal_voucher_form','class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>

<input type="hidden" name="journal_voucher_id" value="<?php echo $row_edit[0]['journal_voucher_id'];?>">
        ...
        <!--<div class="col-md-12">-->
            <table class="table table-bordered table-hover table-sortable mt-3 mb-4" id="tab_logic">
                ...
                <tr id='addr<?php echo $counter;?>' data-id="<?php echo $counter;?>">
                    <input type="hidden" name="journal_voucher_details_id[]" value="<?php echo $value['journal_voucher_details_id']?>" />
                    ...
                    <td data-name="credit_coa_id[]">
                        <select name="credit_coa_id[]" id="eselect2" class="form-control select2"  data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>">
                            <option value=""><?php echo get_phrase('select_coa');?></option>
                            <?php coa_list_h(0,$value['credit_coa_id'],0,0, $account_type); ?>
                        </select>
                    </td>
                    <td data-name="amount[]">
                    ...
                    <?php
                    $path=system_path($value['attachment'], 'journal_voucher');
                    if (file_exists($path))
                    {  
                    ?>
                        <span style="float: left; display: inline-block;" data-toggle="tooltip" title="click to view">
                            <a href="<?php echo display_link($value['attachment'], 'journal_voucher');
