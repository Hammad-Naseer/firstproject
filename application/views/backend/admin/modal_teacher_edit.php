<?php 
$edit_data		=	$this->db->get_where(get_school_db().'.teacher' , array(
'teacher_id' => $param2,
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                    <?php echo form_open(base_url().'admin/teacher/do_update/'.$row['teacher_id'] , array('id'=>'disable_submit_btn','class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        ...
                                        <div>
                                            <span class="btn btn-white btn-file">
                                                ...
                                                <input type="file" value="" name="userfile" accept="image/*">
                                            </span>
                           ...
                           <input type="hidden" class="form-control" name="old_image" value="<?php echo $row['teacher_image'];?>"/>  
                            ...
                            <div class="form-group">
                                <label class="col-sm-4 control-label"><?php echo get_phrase('date_of_birth');?></label>
                                <div class="col-sm-8">
                                    <input type="text" class="datepicker form-control" name="birthday" value="<?php echo $row['birthday'];?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-4 control-label"><?php echo get_phrase('Gender');?></label>
                                <div class="col-sm-8">
                   	...
                   	<div class="form-group">
						<label for="field-1" class="col-sm-4 control-label"><?php echo get_phrase('periods_per_week');?></label>
                        
						<div class="col-sm-8">
<input type="text" class="form-control" id="periods_week" name="periods_week"  value="<?php echo $row['periods_week'];?>" >
						</div>
					</div>
			...
			<div class="form-group">
						<label for="field-1" class="col-sm-4 control-label"><?php echo get_phrase('periods_per_day');?></label>
                        
						<div class="col-sm-8">
<input type="text" class="form-control" id="periods_day" name="periods_day"  value="<?php echo $row['periods_day'];?>" >
						</div>
					</div>
 ...
 <button id="btn1" type="submit" class="btn btn-info"><?php echo get_phrase('edit_teacher');?></button>
                            </div>
                        </div>
                <?php echo form_close();?>
            </div>
...
function get_cnic(){
	...
	var cnic=$('#cnic').val();
      ...
      type: 'POST',
       data: {cnic:cnic},
      url: "<?php echo base_url();?>admin/get_cnic_admin",
      dataType: "html",
      success: function(response) { 
if($.trim(response)=='yes'){
$("#cnic").before('<p id="message" style="color:red;"><?php echo get_phrase('id_already_exist'); ?></p>');
