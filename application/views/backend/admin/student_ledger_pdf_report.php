...
<div id="header" style="height: 100px; width: 100%;">
    ...
    <div style="float: left; margin-top: -15px; margin-left: 100px;"> 
        ...
        <h4 style="margin-top: -25px; text-transform: uppercase; font-size:15px !important;">
            <?php echo get_phrase('student_ledger_report');?>
            <br><b>Account Title : </b> <?= get_coa_name($coa_id) ?><br>
            <b>FROM : </b> <?= date('d/m/Y',strtotime($start_date)); ?> - <b>To : </b> <?= date('d/m/Y',strtotime($end_date)); ?>
        </h4>
    </div>
</div>
