...
<div class="row">
    ...
    <div class="thisrow filterContainer" style="padding:12px;">
        <form action="<?php echo base_url().'vouchers/cash_payment_voucher_listing'?>" method="post" name="cash_payment_form" id="cash_payment_form">
        <div class="row">
            <div class="col-md-12 col-lg-12 col-sm-12">
                ...
                <div class="col-md-4 col-lg-4 col-sm-4">
                    <label><?php echo get_phrase('supplier');?></label>
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                    ...
                                    //if (right_granted('staff_manage'))
                                    {
                                        ?>
                                        <li>
                                            <a href="<?php echo base_url(); ?>vouchers/cash_payment_voucher_detail/<?php echo str_encode($row['cash_payment_id']); ?>">
                                    ...
                                    //if (right_granted('staff_manage'))
                                    {
                                        ...
                                        <li class="divider"></li>
                                        <li>
                                            <a href="<?php echo base_url(); ?>vouchers_pdf/cash_payment_voucher_print/<?php echo str_encode($row['cash_payment_id']); ?>">
                                    ...
                                    if ($status!='Posted')
                                    {
                                        ...
                                        <li class="divider"></li>
                                        <li>
                                            <a href="<?php echo base_url(); ?>vouchers/cash_payment_voucher_edit/<?php echo str_encode($row['cash_payment_id']); ?>">
                                    ...
                                    if ($status!='Posted')
                                    {
                                        ...
                                        <li class="divider"></li>
                                        <li>
                                            <a href="<?php echo base_url(); ?>vouchers/cash_payment_voucher_delete/<?php echo str_encode($row['cash_payment_id']);?>">
...
<script>
    var datatable_btn_url = '<?php echo base_url(); ?>vouchers/cash_payment_voucher';
