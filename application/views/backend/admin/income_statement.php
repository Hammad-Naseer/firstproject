    ...
    <div>
        <div class="row filterContainer" data-step="1" data-position="top" data-intro="Please select the filters and press Filter button to get specific records">
            ...
            <div class="col-md-4">
                ...
                <button type="button" id="select" class="modal_save_btn"> <?php echo get_phrase('filter');?></button>
                <a id="btn_show" href="<?php echo base_url(); ?>transection_account/income_statement" class="modal_cancel_btn" style="display:none;padding:5px 8px !important;">
