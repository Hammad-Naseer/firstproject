<?php 
$parent_information	=	$this->db->get_where(get_school_db().'.parent' , array('parent_id' => $param2) )->result_array();
	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url().'admin/parent/do_update/'.$row['parent_id'].'/'.$param3 , array('id'=>'disable_submit_btn','class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
                    ...
                    <div class="form-group">
						...
						<div class="col-sm-8">
<input id="cnic" type="text" class="form-control" name="cnic" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" value="<?php echo $row['id_card'];?>">
						</div>
					</div>
...
<input onkeypress="get_email()" id="email" type="text" class="form-control" name="email" value="<?php echo $row['email'];?>" >
						</div>
					</div>
                    ...
                    <div class="form-group">
						<div class="col-sm-offset-3 col-sm-5">
							<button id="btn1" type="submit" class="btn btn-default"><?php echo get_phrase('edit_parent');?></button>
						</div>
					</div>
                <?php echo form_close();?>
            </div>
