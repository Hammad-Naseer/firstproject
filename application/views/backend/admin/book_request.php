		...
		<div class="tab-content">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered datatable" id="table_export">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<?php
                            if($row['status']==0){
								echo '<p class="btn btn-primary">'.get_phrase('pending').'</p>';
							} 
							if($row['status']==1){
								echo '<p class="btn btn-success">'.get_phrase('Approved').'</p>';
							}
							if($row['status']==2){
								echo '<p class="btn btn-danger">'.get_phrase('denied').'</p>';
							}
							?>
                            </td>
							<td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                    ...
                                    <!-- DENY LINK -->
                                    <li>
                                        <a href="#" onclick="confirm_modal_update('<?php echo base_url();?>admin/book_request/deny/<?php echo $row['request_id'];?>');">
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open(base_url().'admin/book_issue/create' , array('class' => 'form-horizontal form-groups-bordered validate',
					'target'=>'_top','id'=>'disable_submit_btn'));?>
		 ...
		 <div>
                    <h3 class="warning"><?php echo get_phrase('disclaimer_note'); ?>:</h3>
                    <span><?php echo get_phrase('fine_per_pay_on_returning_the_book_after_the_due_date_is_rs'); ?>.30</span>
                </div>
	</div>
</div>