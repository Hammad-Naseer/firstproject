...
<html lang="en">
    ...
    <body class="page-body login-page is-lockscreen login-form-fall loaded login-form-fall-init" data-url="<?= base_url(); ?>">
        <div class="login-container">
            ...
            <div class="login-form">
                <div class="login-content">
                    <form method="post" action="<?php echo base_url() ?>Inquiries/lock_screen_login" role="form" id="form_lockscreen" novalidate="novalidate">
        ...
        <script>
            // $('#form_lockscreen').on("submit",function(e){
            //     e.preventDefault();
            //     $.ajax({
            //         url: '<?php //echo base_url() ?>Inquiries/lock_screen_login',
            //         async: false,
            //         method: 'POST',
