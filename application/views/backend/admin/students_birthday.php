...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 myt topbar">
        ...
        <h3 class="system_name inline">
               <?php echo get_phrase('students_birthday'); ?>
        </h3>
    </div>
</div>

    <form method="post" action="<?=base_url()?>c_student/students_birthday" class="form-groups-bordered">
        <div class="row filterContainer" data-step="1" data-position='top' data-intro="Please select the filters and press filter button to get record">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                ...
                <a href="<?php echo base_url(); ?>c_student/students_birthday" class="modal_cancel_btn" id="btn_remove"> 
...
<div class="col-lg-12 col-md-12">
    <form  action="<?php echo base_url()?>c_student/wish_birthday" method="post">
	...
	<tbody>
		...
		<tr>
			...
			<td class="td_middle">
				<?php echo date_view($row->birthday);?>
			</td>
            <td class="td_middle">
