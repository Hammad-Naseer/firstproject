        ...
        <div class="col-lg-12 col-md-12 col-sm-12 myt topbar">
            <h3 class="system_name inline">
                ...
                <img class="img-responsive mynavimg2" src="<?php echo base_url();?>assets/images/student-info.png">
                 ...
                 <?php echo get_phrase('class_subject');?>
                
            </h3>
        </div>
    </div>
    <div class="thisrow" style="padding:12px;">
    <form action="<?php echo base_url(); ?>virtualclass/vc_complete_list" method="post" name="student_form">
        <div class="row">
...
<table class="table table-bordered datatable" id="stud_info_tbl">
    <thead>
        <tr>
            ...
            <th style="width:27%;"><?php echo get_phrase('student_name');?></th>
            ...
            <td>
                <div>
                    <div class="btn-group">
                        ...
                        <li>
                            <a href="<?php echo base_url(); ?>virtualclass/view_details/<?php echo $row['subject_section_id']; ?>">
