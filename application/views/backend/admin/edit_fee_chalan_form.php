...
else
{
    ...
    $qur="SELECT * FROM ".get_school_db().".student_chalan_detail 
                WHERE s_c_d_id=$s_c_d_id AND type = 1";
	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url().'fee_types/fee_types_c/add_edit/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data','id'=>'edit_fee_form_id'));?>
					...
					<div class="form-group">
                        ...
                        <?php
                        echo update_fee_chalan_form($fee_id , $s_c_f_id);
                         ?>
						</select>
	...
	$('#save_data').click(function() {
       ...
       // alert(s_c_d_id);
        ...
        $.ajax({
            ...
            url: "<?php echo base_url();?>class_chalan_form/update_fee_chalan_form",
            dataType: "html",
