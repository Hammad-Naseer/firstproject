		...
		<div class="panel panel-primary" data-collapsed="0">
        	<div class="panel-heading">
            	<div class="panel-title" >
					...
					<?php echo get_phrase('edit_candidate');?>
            	</div>
            </div>
			<div class="panel-body">
				<?php echo form_open(base_url().'c_student/student/'.$row['section_id'].'/do_update_c/'.$row['student_id'] , array('id'=>'cadidate_add_edit','class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
...
<a class="btn btn-primary" onclick="delete_files('<?php echo $row['image']; ?>','student','student_id','<?php echo $row['student_id']; ?>','image','student','student_image')">
...
<div class="form-group">
		...
		<input maxlength="50" type="text" class="form-control" name="form_num" value="<?php echo $row['form_num']; ?>" required="" autofocus>
</div>
...
<div class="form-group">
 <label class="control-label"><?php echo get_phrase('class-Section');?><span class="red"> * </span></label> 
        <label id="section_id1_selection"></label>
          ...
          if($param3!="")
          {
        	$val_val=	section_hierarchy($row['section_id']);
          	
          	echo $val_val['d'].'-'.$val_val['c'].'-'.$val_val['s'];
        	?>
          	<br><span style='color: red; font-size: 10px;'>
            
            <?php echo get_phrase('note');?>: 
            <?php echo get_phrase('to_change_section_please_cancel_challan_form');?>
            </span>
          ...
          { ?>  
        <select id="section_id1" class="selectpicker form-control" name="section_id" data-validate="required" data-message-required="Value Required"  required="" class="form-control">
...
<div class="form-group">
		<label for="field-2" class="control-label"><?php echo get_phrase('Date_of Birth');?></label>
        <?php //echo date_dash($row['birthday']);?> 
			<input type="text" class="form-control datepicker" id="birthday" name="birthday" value="<?php echo date_dash($row['birthday']);?>"
            data-start-view="2" data-format="dd/mm/yyyy"> 
</div>
...
<div class="form-group">
	    <label for="field-2" class="control-label"><?php  echo get_phrase('religion'); ?><span class="red">*</span></label>
...
<div class="form-group">
		<label for="field-2" class="control-label"><?php echo get_phrase('mobile_no');?><span class="red"> * </span></label>
    	<input required="" maxlength="20" type="text" class="form-control" name="mobile_num" value="<?php echo $row['mob_num'] ?>" >
</div>
<div class="form-group">
	    <label for="field-2" class="control-label"><?php echo get_phrase('emergency_no');?><span class="red"> * </span></label>
		<input required="" maxlength="20" type="text" class="form-control" name="emg_num" value="<?php echo $row['emg_num']; ?>" >
</div>

<div class="form-group">
	    <label for="field-2" class="control-label"><?php echo get_phrase('postal_address');?></label>
        ...
        <div class="panel panel-primary" data-collapsed="0" style="margin-left: -15px;margin-right: -15px;">
			<div class="panel-heading" id="toclick">
    		...
    		<div class="panel-body" id="toslide">
			<div class="form-group">
			...
			<div class="form-group">
				<label for="field-2" class="col-sm-4 control-label"><?php echo get_phrase('permanent_address'); ?></label>
						<div class="col-sm-8">
						<textarea rows="5" id="per_cont_p" class="form-control" name="p_address" 
                        oninput="count_value('per_cont_p','per_count_p','200')" 
                        maxlength="200" ><?php echo $row['p_address'];  ?>
                        </textarea>
...
<input maxlength="30" minlength="3" type="text" class="form-control" id="cnic_n" name="form_b" onchange="get_cnic('cnic_n','s','student')" value="<?php echo $row['id_no']; ?>" onkeyup="nospaces(this)" >
						</div> 
					</div>
...
<div class="col-sm-8">
<select name="country" class="form-control country">					<?php echo country_option_list($country_id); ?></select>
</div> 
	</div>
<div class="form-group">
<label for="field-2" class="col-sm-4 control-label"><?php echo get_phrase('provience');?></label>
<div class="col-sm-8 provience_html">
...
function get_cnic(cnic_n, type_n, table_name, detail_field) {
   ...
   //          	alert(response);
    ...
    <script>
        $(function() {
            //$( "#birthday" ).datepicker();
           // $( "#birthday" ).datepicker("setDate", "10w+1");
        });
    </script>
<style>
.loader {
