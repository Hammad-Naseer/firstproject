...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 myt topbar">
        <h3 class="system_name inline">
            <?php echo get_phrase('edit_cash_receipt_voucher');?>
        </h3>
    </div>
</div>
...
<div class="col-md-12">
    <ul class="nav nav-tabs" role="tablist">
    	...
    	<li class="nav-item">
    		<a class="nav-link active" data-toggle="tab" href="#tabs-2" role="tab">Other Receipt</a>
    	</li>
    	<?php } ?>
    </ul><!-- Tab panes -->
    <?php if($row_edit[0]['voucher_type'] == 1){ ?>
    	<div class="tab-pane active" id="tabs-1" role="tabpanel">
            <?php echo form_open(base_url().'vouchers/cash_receipt_voucher_update' , array('id'=>'cash_receipt_form','class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
                <input type="hidden" name="cash_receipt_id" value="<?php echo $row_edit[0]['cash_receipt_id'];?>">
                    ...
                    <div class="row" style="background-color: #c0c0c04a;border: 1px solid #CCC; margin-bottom: 10px;">
                            <table class="table table-bordered table-hover table-sortable mt-4 mb-4" id="tab_logic">
                                ...
                                <tr id='addr<?php echo $counter;?>' data-id="<?php echo $counter;?>">
                                    ...
                                    <?php
                                    $path=system_path($value['attachment'], 'cash_receipt');
                                    if (file_exists($path))
                                    {  
                                    ?>
                                        <span style=" display: inline-block;" data-toggle="tooltip" title="click to view">
                                            <a href="<?php echo display_link($value['attachment'], 'cash_receipt');
    ...
    <?php if($row_edit[0]['voucher_type'] == 2){ ?>
    	<div class="tab-pane active" id="tabs-2" role="tabpanel">
    	    <?php echo form_open(base_url().'vouchers/other_cash_receipt_voucher_update' , array('id'=>'other_cash_receipt_voucher_update','class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
                <input type="hidden" name="cash_receipt_id" value="<?php echo $row_edit[0]['cash_receipt_id'];?>">
                <div class="thisrow" style="padding:12px;">
                    <div class="row">
                        <div class="col-md-12 col-lg-12 col-sm-12">
                ...
                <div class="col-md-12">
                    <div class="row" style="background-color: #c0c0c04a;border: 1px solid #CCC; margin-bottom: 10px;">
                            ...
                            <div class="col-md-12">
                                <a id="add_row" class="modal_save_btn float-right mb-4"><i class="fa fa-plus" aria-hidden="true" style="color: white;"></i></a> 
                            </div>
                    </div>
                </div>
                <div class="thisrow" style="padding:12px;">
