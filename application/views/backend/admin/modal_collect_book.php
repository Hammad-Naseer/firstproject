...
<script>
$("input[name='collect_date']").datepicker({
    startDate:"+0d",
    endDate:"+0d"
});</script>
    ...
    <div class="box-content" >
        <?php foreach($edit_data as $row):
            ...
            $x=0;?>
        <?php echo form_open(base_url().'admin/book_request/do_collect/'.$row['book_id'] , array('id'=>'disable_submit_btn','class' => 'form-horizontal form-groups-bordered validate','target'=>'_top','onSubmit'=>'return validate();'));?>
...
<input type="text" id="expiryDate" class="form-control" name="expiry_date" value="<?php echo $book['expiry_date'];?>" readonly/>
                ...
                <div class="form-group">
                    <label class="col-sm-4 control-label"><?php echo get_phrase('collect_date');?></label>
                    <div id="collectdate" class="col-sm-5">
    ...
    $(this).attr('value',date);
        ...
        <div id="fine" class="form-group">
                        <label class="col-sm-4 control-label"><?php echo get_phrase('fine_imposed');?></label>
                        <div class="col-sm-8">
