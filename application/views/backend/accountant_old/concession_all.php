...
$this->db->from('concession');
$this->db->join('student', 'student.student_id = concession.student_id');
                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                        ...
                                        <li>
                                        	<a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_teacher_edit/<?php echo $row['Concession_id'];?>');">
                                        ...
                                        <li>
                                        	<a href="#" onclick="confirm_modal('<?php echo base_url();?>accountant/get_pending_chalan/delete/<?php echo $row['concession_id'];?>');">
