...
<?php echo form_open(base_url().'accountant/student/chalan/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
<div class="col-md-12">
...
<option value="2030">2030</option>
 ...
 <!-- label ends here-->
  ...
  <div class="col-md-1 boarder"></div>
   <input type="hidden" id="student_id" name="student_id" value="<?php echo $last_insert_id;?>"/>
