...
<nav class="navbar navbar-expand-lg navbar-light  ">
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ">
        <li class="nav-item">
          <a href="#About-Us"><img src="<?=$custom_base_url?>img/information1.png" class=" mx-auto d-block" alt="account1 Menu">
          <span class="nav-link active" aria-current="page">About Us</span></a>
        </li>
        <li class="nav-item">
          <a href="#LMS-Login"><img src="<?=$custom_base_url?>img/account1.png" class=" mx-auto d-block" alt="account1 Menu">
          <a class="nav-link">LMS Login</span></a>
        </li>
        <li class="nav-item">
          <a href="#Online-Admissions"><img src="<?=$custom_base_url?>img/admission1.png" class=" mx-auto d-block" alt="account1 Menu">
          <span class="nav-link">Online Admissions</span></a>
        </li>
        <li class="nav-item">
          <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"><img src="<?=$custom_base_url?>img/inquiry1.png" class=" mx-auto d-block" alt="account1 Menu">
          <span class="nav-link">General Inquiry</span></a>
        </li>
        <li class="nav-item">
          <a href="#News-Events"><img src="<?=$custom_base_url?>img/file1.png" class=" mx-auto d-block" alt="account1 Menu"> 
          <span class="nav-link">News & Events</span></a>
        </li>
        <li class="nav-item">
          <a href="#lms-jobs"><img src="<?=$custom_base_url?>img/job-icon.png" class=" mx-auto d-block" alt="account1 Menu"> 
          <span class="nav-link">Careers</span></a>
        </li>
        <li class="nav-item">
          <a href="#Contact-Us"><img src="<?=$custom_base_url?>img/contact1.png" class=" mx-auto d-block" alt="account1 Menu">
