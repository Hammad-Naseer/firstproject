				...
				<div class="col-sm-2">
					<a href="#" class="profile-picture">
					    <?php if($edit_data[0]['profile_pic']=="") { ?>
    					    <img src="<?php echo get_default_pic()?>" class="img-responsive img-circle w-75" /> 
    					<?php } else {?>
					...
					<ul class="profile-info-sections">
						...
						<li>
							<div class="profile-stat">
								<h3> <?php echo $_SESSION['department_name']." - ".$_SESSION['class_name']." - ".$_SESSION['section_name']; ?></h3>
								<span><a href="#">Department - Class - Section</a></span>
							</div>
						</li>
    ...
    <div class="row prfl-user">
        <div class="col-lg-12 col-sm-12 b-s mt-4 p-3">
            ...
            foreach($edit_data as $row){
                ...
                ?>
                <?php echo form_open_multipart(base_url().'student_p/my_profile' , array('class' => 'form-horizontal','target'=>'_top'));?>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="form-group">
                    <label  class="control-label" style="float:left;"><?php echo get_phrase('display_picture');?></label>
                        <div class="fileinput fileinput-new" data-provides="fileinput">
                        <input type="hidden" name="image_file" value="<?php echo  $row['profile_pic']; ?>"/>
                        <div class="fileinput-new thumbnail" style="height: 130px;width: 130px;" data-trigger="fileinput" id="student_image">
        ...
        <div class="col-lg-12 col-sm-12 b-s mt-4 p-3" data-step="2" data-position='top' data-intro="change your password">
        	...
        	<div class="box-content change-password">
    			<?php foreach($edit_data as $row): ?>
                    <?php echo form_open_multipart(base_url().'Student_p/manage_profile/change_password' , array('class' => 'form-horizontal','target'=>'_top'));?>
                        <div class="row">
