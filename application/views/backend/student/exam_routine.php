<style>
.panel-default>.panel-heading>.panel-title>a{color:#196ca7}.panel-group.joined>.panel>.panel-heading{background-color:#012b3c;}
</style>
...
<div class="row">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="panel-group joined" id="collapse" data-step="1" data-position='top' data-intro="Exam datesheet term wise">
            <?php 
                $toggle = true;
            ...
            <div class="panel panel-default">
                ...
                <div id="collapse<?php echo $row['exam_id'];?>" class="panel-collapse collapse">
