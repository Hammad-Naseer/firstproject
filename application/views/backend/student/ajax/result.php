...
<div class="col-lg-12 col-md-12 col-sm-12">
    <table class="table table-bordered table_export">
            <thead>
                <tr>
                    <th style="width: 134px; text-align: center; font-weight:bold;">
                        <div>
            ...
            <?php $obt=0; $total=0;
                    ...
                    foreach($result as $arr){
                    	$obt+=get_total_obtained($exam_id,$arr['marks_id'],$arr['subject_id']);
                    	$total+=get_total_marks($exam_id,$student_arr[0]['section_id'],$arr['subject_id']);
                    	?>
                        <tr>
                            <td>
                            ...
                            <td class="total">
                                <?php 
            						echo  $total_marks =  get_total_marks($exam_id,$student_arr[0]['section_id'],$arr['subject_id']);
            					?>
                            </td>
                            <td class="obtained">
                                <?php 
            						echo $marks_obtained = get_total_obtained($exam_id,$arr['marks_id'],$arr['subject_id']);	
            					?>
                            </td>
                            <td>
                                <?php 
                                $percent_obtained = ($marks_obtained/$total_marks*100);
                                echo get_grade($percent_obtained);
            ...
            <tr>
                ...
                <td id="total-marks"><strong><?php echo $total?></strong></td>
                <td id="total-obt"><strong><?php echo $obt?></strong></td>
                <td>
                    <strong>
                        <?php
                        $percent=round($obt/$total *100);
