...
<div class="row demo" id="print_form">
    ...
    ?>
                ...
                <div  class="page chalan_copy" style="width:25%;float: left;margin-left: 10px;overflow: hidden;;border: 0px solid #eee;margin-bottom:0px;page-break-after: always;">
                    ...
                    <div class="watermark"><?php echo $status;?></div>
                        <tr>
                            <td style="border-right:none !important;     width: 100px; ">
                                ...
                                ?>
                                <img src="<?php echo base_url().'uploads/'.$folder_name. '/'.$logo/*display_link($row_data['school_logo'],'')*/
                        ...
                        <tr>
                            <td colspan="2" style="border-top:none !important;   border-bottom:none !important; font-size: 12px; ">
                               ...
                               <br><br><br>
                                ...
                                <center>
                                    <img src="<?php echo base_url().'uploads/'.$folder_name. '/student/'.$row_data['bar_code'] ?>">
                                </center>
                                <br><br>
