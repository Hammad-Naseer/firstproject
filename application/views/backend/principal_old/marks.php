	...
	<div class="col-md-12">
    	...
    	<!------CONTROL TABS END------->
            ...
            <div class="tab-pane  <?php if(!isset($edit_data) && !isset($personal_profile) && !isset($academic_result) )echo 'active';?>" id="list">
				<center>
                <?php echo form_open(base_url().'principal/marks');?>
                <table border="0" cellspacing="0" cellpadding="0" class="table table-bordered">
                	...
                	<tr>
                        ...
                        <td>
                    		...
                    		<input type="submit" value="<?php echo get_phrase('view_marks');?>" class="btn btn-info" />
                        </td>
                	</tr>
                </table>
                </form>
                    ...
                    <tbody>
						...
						foreach($students as $row):
							...
							<tr>
								...
								<td>
									 <input type="text" value="<?php echo $row2['mark_obtained'];?>" name="mark_obtained" class="form-control" readonly />
												
								</td>
                                <td>
                                	<input type="text" value="<?php echo $row2['attendance'];?>" name="attendance" class="form-control" readonly />
                                </td>
								<td>
