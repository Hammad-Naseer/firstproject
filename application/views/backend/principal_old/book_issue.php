            ...
            <div class="tab-pane box active" id="list">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered datatable" id="table_export">
                    ...
                    <tbody>
                        ...
                        <?php
							$query10	=	$this->db->get_where('book_issue' , array('request_id' => $row));
                        ...
                        <tr>
							...
							<td><?php 
							$query1	=	$this->db->get_where('book_request' , array('request_id' => $row));
							$res1	=	$query1->result_array();
							foreach($res1 as $row1){
								$book_id		=	$row1['book_id'];
							}
							$query2	=	$this->db->get_where('book' , array('book_id' =>$book_id));
                            ...
                            <td>
							<?php
							$query3	=	$this->db->get_where('book_request' , array('request_id' => $row));
							$res3		=	$query3->result_array();
							foreach($res3 as $row3){
								$principal_id		=	$row3['principal_id'];
							}
							...
							<?php
                            $query5		=	$this->db->get_where('book_issue' , array('request_id' => $row));
