                                  ...
                                  <table class="table table-bordered " >
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?php echo get_phrase('highest_mark');?></th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    $query = $this->db->get_where(get_school_db().'.mark' , $verify_data);							 
                                    ...
                                    <hr />
                                    <?php echo get_phrase('gpa');?>(<?php echo get_phrase('grade_point_average');?>) : <?php echo round($total_grade_point/$total_subjects , 2);?>
                                </center>
                                </div>
                          	</div>
                        </div>
