...
<div class="row">
    ...
    <form method="post" action="<?=base_url()?>teacher/students_birthday" class="form-groups-bordered">
        <div class="row filterContainer" data-step="1" data-position='top' data-intro="Please select the filters and press filter button to get record">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                ...
                <a href="<?php echo base_url(); ?>teacher/students_birthday" class="modal_cancel_btn" id="btn_remove"> 
