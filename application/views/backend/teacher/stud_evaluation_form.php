...
$stud_eval_query="SELECT * FROM ".get_school_db().".student_evaluation WHERE student_id=".$student_id." AND exam_id=".$exam_id."  AND subject_id=".$subject_id." AND school_id=".$_SESSION['school_id']." And evaluated_by = 2 And who_evaluated = ".$_SESSION['user_id'];
...
?>
        ...
        <form action="<?php echo $url.'/'.$student_id.'/'.$exam_id.'/'.$section_id; ?>" method="post" class="form-horizontal form-groups-bordered validate" enctype="multipart/form-data">
            <input type="hidden" name="evaluated_by" value="2"/>
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    <th colspan="2">
                                        <div>
                                            <?php echo get_phrase('Teacher remarks');?>
                                        </div>
                                    </th>
                                </tr>
                            </thead>
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea name="remarks" id="remarks" maxlength="500" oninput="count_value('remarks','remarks_count','500')" rows="5" required class="form-control required-field"><?php echo trim($stud_eval_edit[0]['remarks']);?></textarea>
