...
<div class="col-md-12">
        ...
        <div class="panel panel-primary" style="margin-bottom: 0;">
            ...
            <div class="panel-header bg-primary text-white" style="padding: 10px;font-weight: bold;"><b>Add Assessment</b></div>
             
            <div class="panel-body">
   
                <form id="assessment_form" action="<?php echo base_url(); ?>assessment/save_assessment" method="POST"> 
                         
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" data-step="1" data-position='top' data-intro="enter assessment title">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" data-step="5" data-position='top' data-intro="enter no of attempts">
                              ...
                              <input type="number" class="form-control" name="total_attempts" id="total_attempts" required>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
                                <button data-step="16" data-position='top' data-intro="press this button save assessment then you add assessment questions" 
                                style="margin-top:20px !important;" type="submit" id="submit" class="btn btn-default submit_btn" 
                                onclick = "validate_form();">Save Assessment</button>
                            </div>
                        </div>     
